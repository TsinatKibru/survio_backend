...
MIDDLEWARE = [
    ...
    'survio.middleware.LoginRateLimitMiddleware',
    'survio.middleware.InputValidationMiddleware',
]

ROOT_URLCONF = 'survio.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'survio.context_processors.csp_nonce',
            ],
        },
    },
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'accounts.authentication.JWTAuthenticationWithRevocation',
